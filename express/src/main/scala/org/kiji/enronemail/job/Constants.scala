...
object Constants {
  val englishStopWords =
    HashSet("a", "a’s", "able", "about", "above", "according", "accordingly", "across", "actually", "after",
      "afterwards", "again", "against", "ain’t", "aint", "all", "allow", "allows", "almost", "alone", "along",
      "already", "also", "although", "always", "am", "among", "amongst", "an", "and", "another", "any",
      "anybody", "anyhow", "anyone", "anything", "anyway", "anyways", "anywhere", "apart", "appear",
      "appreciate", "appropriate", "are", "aren’t", "arent", "around", "as", "aside", "ask", "asking",
      ...
      "c’s", "came", "can", "can’t", "cant", "cannot", "cant", "cause", "causes", "certain", "certainly",
      "changes", "clearly", "co", "com", "come", "comes", "concerning", "consequently", "consider",
      "considering", "contain", "containing", "contains", "corresponding", "could", "couldn’t", "couldnt", "course",
      "currently", "definitely", "described", "despite", "did", "didn’t", "didnt", "different", "do", "does",
      "doesn’t", "doesnt", "doing", "don’t", "dont", "done", "down", "downwards", "during", "each", "edu", "eg", "eight",
      ...
      "gives", "go", "goes", "going", "gone", "got", "gotten", "greetings", "had", "hadn’t", "hadnt", "happens",
      "hardly", "has", "hasn’t", "hasnt", "have", "haven’t", "havent", "having", "he", "he’s", "hello", "help", "hence",
      "her", "here", "here’s", "hereafter", "hereby", "herein", "hereupon", "hers", "herself", "hi",
      "him", "himself", "his", "hither", "hopefully", "how", "howbeit", "however", "i", "i’d", "i’ll", "i’m", "im",
      "i’ve", "ie", "if", "ignored", "immediate", "in", "inasmuch", "inc", "indeed", "indicate",
      "indicated", "indicates", "inner", "insofar", "instead", "into", "inward", "is", "isn’t", "isnt", "it",
      ...
      "several", "shall", "she", "should", "shouldn’t", "shouldnt", "since", "six", "so", "some", "somebody",
      ...
      "wants", "was", "wasn’t", "wasnt", "way", "we", "we’d", "we’ll", "we’re", "we’ve", "welcome", "well",
      "went", "were", "weren’t", "werent", "what", "what’s", "whatever", "when", "whence", "whenever", "where",
      ...
      "willing", "wish", "with", "within", "without", "won’t", "wont", "wonder", "would", "would", "wouldn’t", "wouldnt",
      "yes", "yet", "you", "you’d", "youd", "you’ll", "you’re", "youre", "you’ve", "youve", "your", "yours", "yourself",
      "yourselves", "zero")
}
